...
public class Common {
    ...
    public static boolean _privateNode = false;

    public static void loadValidATS() {
        try {
    ...
    public static String saveToken(String name,String symbol,int decimals,double totalSupply) {
        String contents = "";
